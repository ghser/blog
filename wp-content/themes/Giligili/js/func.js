...
function fancyboxinit() {
    $('#main-content .post img:not(.OwO-img, .avatar, .no-fancy)').each(function(i){
...
function initHeader() {
    containerID = $(".thumbnail-shadow")[0],
    ...
    circles = [];
    for (var t = 0; t < .1 * width; t++) {
        var e = new Circle;
        circles.push(e)
    }
    1 == canvasload && (animate(),
    canvasload = 0)
}
...
var width, height, containerID, canvasID, ctx, circles, target, animateHeader = !0, canvasload = 1;
eval(function(t, e, i, n, o, a) {
    if (o = function(t) {
        return (t < 62 ? "" : o(parseInt(t / 62))) + ((t %= 62) > 35 ? String.fromCharCode(t + 29) : t.toString(36))
    }
    ,
    !"".replace(/^/, String)) {
        for (; i--; )
